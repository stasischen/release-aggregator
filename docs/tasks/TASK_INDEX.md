...
| DICTIONARY_ENTRY_DRIFT_REVIEW | Korean dictionary entry drift audit（homonym/polysemy、Hanja/source metadata、resolver `entry_refs` readiness） | C+/Lexicon | pro | 0/4 tasks | [PLAN](DICTIONARY_ENTRY_DRIFT_REVIEW_PLAN.md) |
