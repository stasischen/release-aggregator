...
| :--- | :--- | :--- | :--- | :--- |
| MAPPING_DICTIONARY | 字典映射標準化 + 品質驗證（含雙層詞性落地） | A2 | 8/14 tasks | [JSON](MAPPING_DICTIONARY_TASKS.json) · [PLAN](KO_DICT_01_PLAN.md) |
| KO_GEMINI_REVIEW | KO 全量 Gemini 人工審核（mapping + TOPIK POS，含 i18n/base 詞性人工複核） | A2 | 4/7 tasks | [JSON](KO_GEMINI_REVIEW_TASKS.json) |
...
| KO_B2_C1_OPTIMIZATION | B2/C1 課程優化：角色大修、商務/評論語氣、翻譯與文法補全 | B2/C1 | 6/9 tasks (KO-B2-03: L01-L25 Completed) | [JSON](KO_B2_C1_OPTIMIZATION_TASKS.json) · [PLAN](KO_B2_C1_OPTIMIZATION_PLAN.md) |
