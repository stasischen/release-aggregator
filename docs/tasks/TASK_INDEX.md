...
| PRODUCTION_RELEASE_GATING | Staging candidate / production release gate（全量進 staging、allowlist 才能發佈 production） | C+/Ops | 3/6 tasks | [JSON](PRODUCTION_RELEASE_GATING_TASKS.json) · [ARCH](STAGING_CANDIDATE_VS_PRODUCTION_RELEASE_ARCHITECTURE.md) |
...
| Task ID | 描述 | Phase | 進度 | 檔案 |
| :--- | :--- | :--- | :--- | :--- |
| KNOWLEDGE_LAB_ENRICHMENT | Knowledge Lab 內容充實（knowledge/topic/link/vocab/retrieval 補強；不得改 frontend intake contract） | Lab/Ops | 2/5 tasks | [JSON](KNOWLEDGE_LAB_ENRICHMENT_TASKS.json) |
