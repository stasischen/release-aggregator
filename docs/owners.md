...
| `release-aggregator` | Release Manager | Collect artifacts, provenance manifest, release promotion/rollback, control-tower docs | Content mutation, frontend code changes |
