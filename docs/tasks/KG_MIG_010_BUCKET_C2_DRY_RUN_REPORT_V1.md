...
| `ex.ko.grammar.ending.additive_eulppunderseo.interesting_useful.v1` | `재미있을뿐더러 유익해요` | `kg.grammar.ending.additive_eulppunderseo` | Ready |
...
- **Normalization Stability**: All high-confidence candidates are now pure Hangul. Mixed-script placeholders (e.g., `유익해요`) have been fixed in the manifest.
