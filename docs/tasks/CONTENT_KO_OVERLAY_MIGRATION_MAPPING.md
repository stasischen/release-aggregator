...
| Source ID | 來源 (Legacy / Mockup) | 類別 |
| --- | --- | --- |
| `src.ko.video.79Pwq7MTUPE` | `docs/tasks/mockups/ko_video_learning_mockup_79Pwq7MTUPE.json` | video |
| `src.ko.dialogue.a1_01` | `content/core/dialogue/l1_a1_01_greeting.json` | dialogue |
| `src.ko.article.a1_01_intro` | — (App Prototype 內的新增內容) | article |
