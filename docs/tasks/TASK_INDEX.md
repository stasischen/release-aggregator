...
| :--- | :--- | :--- | :--- | :--- |
| MAPPING_DICTIONARY | 字典映射標準化 + 品質驗證（含雙層詞性落地） | A2 | 13/15 tasks | [JSON](MAPPING_DICTIONARY_TASKS.json) · [PLAN](KO_DICT_01_PLAN.md) |
| CROSS_LANG_REVIEW_LOCK | 跨語系 review/lock 流程（多機協作 + 規則分離） | A2/B1 | 6/7 tasks | [JSON](CROSS_LANG_REVIEW_LOCK_TASKS.json) · [PLAN](CROSS_LANG_REVIEW_LOCK_PIPELINE_PLAN.md) |
...
| Task ID | 描述 | Phase | 進度 | 檔案 |
| :--- | :--- | :--- | :--- | :--- |
| COURSE_UNIT_FACTORY | 課程單元量產工廠（unit blueprint 模板化 + lint + multi-unit mockup 驗證） | C+/Ops | 2/8 tasks | [JSON](COURSE_UNIT_FACTORY_TASKS.json) · [PLAN](COURSE_UNIT_FACTORY_PLAN.md) |

### Phase B/C — 待 Phase A 完成後啟動

| Task ID | 描述 | Phase | 進度 | 檔案 |
| :--- | :--- | :--- | :--- | :--- |
| CONTENT_PIPELINE_SEPARATION | 職責分離 + Build 格式 | B1 | 6/6 tasks | [JSON](CONTENT_PIPELINE_SEPARATION_TASKS.json) |
| CONTENT_PIPELINE_POST_SEPARATION_GAPS | Universal Pipeline 後續缺口收斂（Yarn / Mapping Split / Lemma Heuristic / Validation Integration） | B1/B2 | 0/4 tasks | [JSON](CONTENT_PIPELINE_POST_SEPARATION_GAPS_TASKS.json) |
