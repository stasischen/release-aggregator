...
| MODULAR_LESSON_RUNTIME_CONTRACT_BRIEF | Modular lesson runtime article/support/video contract options inventory | C+/Frontend Contract | flash -> pro | 0/4 tasks | [JSON](MODULAR_LESSON_RUNTIME_CONTRACT_BRIEF/TASKS.json) · [BRIEF](MODULAR_LESSON_RUNTIME_CONTRACT_BRIEF/TASK_BRIEF.md) |
