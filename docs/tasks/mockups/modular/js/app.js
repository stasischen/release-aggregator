...
window.renderCurrentNode = function () {
    ...
    // Core Shell Renderers (now in core.js)
    ...
    let bodyHtml = `<div id="detailNodeContent">${contentHtml}</div>`;
    ...
    // If there's an interaction area that needs immediate secondary rendering (like practice cards)
    if (document.getElementById('interactionArea')) {
