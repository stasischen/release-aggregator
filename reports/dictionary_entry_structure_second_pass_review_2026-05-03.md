...
| 分類 | 筆數 | 詞條 |
|------|------|------|
| APPROVED_EXACT_PATCH | 18 | 문제, 경우, 자신, 정도, 시간, 사실, 이상, 시장, 지방, 구조, 의식, 발전, 시, 입장, 예, 모양, 의원, 회의 |
| REJECTED | 0 | — |
| NEEDS_MANUAL_REVIEW | 2 | 과정, 기능 |
...
### 1. ko:n:과정 — gloss 污染 + Gemini incorrectly merges s2 into entry_no:1

| 欄位 | 值 |
|------|-----|
| Atom ID | `ko:n:과정` |
| File Path | `content_v2/inventory/dictionary/2026-04-30-fix/n.jsonl` |
| 問題 | s2 gloss「抑揚；語調」明顯是資料污染（應屬 `ko:n:억양`），Gemini 提案將 s2 `entry_no` 從 2 改為 1（合併到 過程），此舉錯誤——污染定義應保持獨立的 entry_no |
| 建議 | 人工追溯 s2 的 source_ref (`batch_6001_6050.jsonl:25`) 確認原始資料歸屬；s1 的 hanja 下層化可單獨處理 |

**Current Record (line 61):**
```
{"atom_id": "ko:n:과정", "definitions": {"zh_tw": [{"entry_no": 1, "gloss": "過程；經過；流程", "is_provisional": true, "sense_id": "s1"}, {"entry_no": 2, "gloss": "抑揚；語調", "is_provisional": true, "sense_id": "s2"}]}, "difficulty_rank": null, "id": "ko:n:과정", "lemma": "과정", "mapping_status": "ok", "metadata": {"explanation": "을 겪다", "hanja": "過程", "is_provisional": true, "nikl_level": "중급", "nikl_rank": 188, "source_status": "staging", "topik_level": "C", "usage_rank": 185}, "nikl_level": "중급", "nikl_rank": 188, "pos": "n", "relations": [], "source_refs": ["content_v2_staging:batch_151_200.jsonl:38", "content_v2_staging:batch_6001_6050.jsonl:25"], "status": "active", "surface_forms": ["과정"], "tags": ["nikl_seed", "provisional"], "topik_level": "C", "translation": {"zh_tw": "過程；經過；流程"}, "usage_rank": 185}
```

**Gemini Proposed (REJECTED — do NOT apply):**
```
{"atom_id": "ko:n:과정", "definitions": {"zh_tw": [{"entry_no": 1, "gloss": "過程；經過；流程", "is_provisional": true, "sense_id": "s1", "hanja": "過程"}, {"entry_no": 1, "gloss": "抑揚；語調", "is_provisional": true, "sense_id": "s2", "hanja": null}]}, ...}
```
> Gemini 錯誤地將 s2 從 entry_no:2 改為 entry_no:1，合併了兩個不相關的 homonym。

---

### 2. ko:n:기능 — s3 gloss 污染「機難」

| 欄位 | 值 |
|------|-----|
| Atom ID | `ko:n:기능` |
| File Path | `content_v2/inventory/dictionary/2026-04-30-fix/n.jsonl` |
| 問題 | s3 gloss「技能；機難」中「機難」不是任何真實中文詞彙，幾乎肯定是「技能」的字形誤植（機→技、難→能）。雖然 Gemini 的 entry_no 修正（s2: 2→1 歸入 機能）正確，但 gloss 污染使整筆不得 auto patch |
| 建議 | 人工確認 s3 正確 gloss 應為「技能」或「技能；技藝」，修正後可單獨對 s1/s2 套 entry_no+hanja patch |

**Current Record (line 234):**
```
{"atom_id": "ko:n:기능", "definitions": {"zh_tw": [{"entry_no": 1, "gloss": "功能；機能", "is_provisional": true, "sense_id": "s1"}, {"entry_no": 2, "gloss": "功能；職能", "is_provisional": true, "sense_id": "s2"}, {"entry_no": 2, "gloss": "技能；機難", "is_provisional": true, "sense_id": "s3"}]}, "difficulty_rank": null, "id": "ko:n:기능", "lemma": "기능", "mapping_status": "ok", "metadata": {"explanation": "이 다양하다", "hanja": "機能", "is_provisional": true, "nikl_level": "중급", "nikl_rank": 531, "source_status": "staging", "topik_level": "C", "usage_rank": 514}, "nikl_level": "중급", "nikl_rank": 531, "pos": "n", "relations": [], "source_refs": ["content_v2_staging:batch_501_550.jsonl:29", "content_v2_staging:batch_5301_5350.jsonl:14"], "status": "active", "surface_forms": ["기능"], "tags": ["nikl_seed", "provisional"], "topik_level": "C", "translation": {"zh_tw": "功能；機能"}, "usage_rank": 514}
```

**Gemini Proposed (REJECTED — do NOT apply):**
```
{"atom_id": "ko:n:기능", "definitions": {"zh_tw": [{"entry_no": 1, "gloss": "功能；機能", "is_provisional": true, "sense_id": "s1", "hanja": "機能"}, {"entry_no": 1, "gloss": "功能；職能", "is_provisional": true, "sense_id": "s2", "hanja": "機能"}, {"entry_no": 2, "gloss": "技能；機難", "is_provisional": true, "sense_id": "s3", "hanja": "技能"}]}, ...}
```
> entry_no 和 hanja 修正正確，但 gloss「機難」污染使整筆必須人工處理。
...
**Replacement:**
```
{"atom_id": "ko:n:지방", "definitions": {"zh_tw": [{"entry_no": 1, "gloss": "地方；地區", "is_provisional": true, "sense_id": "s1", "hanja": "地方"}, {"entry_no": 1, "gloss": "鄉下；郊外", "is_provisional": true, "sense_id": "s2", "hanja": "地方"}, {"entry_no": 4, "gloss": "脂肪", "is_provisional": true, "sense_id": "s3", "hanja": "脂肪"}]}, "difficulty_rank": null, "id": "ko:n:지방", "lemma": "지방", "mapping_status": "ok", "metadata": {"explanation": "남쪽 지방", "hanja": null, "is_provisional": true, "nikl_level": "초급", "nikl_rank": 275, "source_status": "staging", "topik_level": "B", "usage_rank": 272}, "nikl_level": "초급", "nikl_rank": 275, "pos": "n", "relations": [], "source_refs": ["content_v2_staging:batch_251_300.jsonl:25", "content_v2_staging:batch_7901_7950.jsonl:7", "content_v2_staging:gloss_fill_workflow_batch_37_output.staging.jsonl:10"], "status": "active", "surface_forms": ["지방"], "tags": ["nikl_seed", "provisional"], "topik_level": "B", "translation": {"zh_tw": "地方；地區"}, "usage_rank": 272}
```
...
1. **ko:n:과정** — s2 gloss「抑揚；語調」是跨詞條資料污染（高度疑似應屬 `ko:n:억양`）。Gemini 提案又錯誤地將 s2 的 `entry_no` 從 2 改為 1（合併到 過程），使情況更糟。建議優先追溯 `batch_6001_6050.jsonl:25` 來源。
2. **ko:n:기능** — s3 gloss「機難」幾乎可確定是「技能」的字形誤植，非真實中文詞彙。需人工確認正確 gloss 後再處理。

### 是否建議 Codex 直接套 approved patch

**建議直接套用。** 18 筆 APPROVED_EXACT_PATCH 中：
- 7 筆僅做 hanja 下層（문제, 경우, 정도, 시간, 사실, 모양, 시장 — 後者 entry_no 本就正確）
- 11 筆同時做 homonym split re-indexing + hanja 下層
...
唯一注意：`ko:n:지방` s3 保留 entry_no:4（非連續索引），為既存異常，非本次引入。
