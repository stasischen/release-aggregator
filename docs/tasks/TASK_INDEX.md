...
| LIBRARY_REFERENCE_STITCH_UI_TRANSFER | Google Stitch Library reference UI transfer（Knowledge-First Lab reference browser / Sentence evidence / Dictionary / Video overlay；遵守 source-first 多層架構與 light/dark 安全） | C+/Frontend Product UI | flash -> pro | 3/10 tasks | [JSON](LIBRARY_REFERENCE_STITCH_UI_TRANSFER/TASKS.json) · [BRIEF](LIBRARY_REFERENCE_STITCH_UI_TRANSFER/TASK_BRIEF.md) |
