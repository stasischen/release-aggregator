...
| :--- | :--- | :--- | :--- | :--- | :--- |
| FRONTEND_V2_INTAKE_COMPLETION | 前端 study / dictionary / UI 顯示資料收斂到 `content_v2` 衍生 stable contract | C+/Frontend Contract | flash -> pro | 1/6 tasks | [JSON](FRONTEND_V2_INTAKE_COMPLETION/TASKS.json) · [BRIEF](FRONTEND_V2_INTAKE_COMPLETION/TASK_BRIEF.md) |
